...
|---|---|---|
| Data de execução do run | ✅ público | BEORYS_PCT_v0.2_METHOD.md |
| Número de modelos avaliados (5) | ✅ público | BEORYS_PCT_v0.2_METHOD.md |
| Número de casos (100) | ✅ público | BEORYS_PCT_v0.2_METHOD.md |
| Número de categorias (7) | ✅ público | BEORYS_PCT_v0.2_METHOD.md |
| Número de execuções (2.500) | ✅ público | BEORYS_PCT_v0.2_METHOD.md |
| Grupos avaliados (A–E) e seus tipos | ✅ público | BEORYS_PCT_v0.2_METHOD.md |
| Métricas utilizadas (nomes) | ✅ público | BEORYS_PCT_v0.2_METHOD.md |
| Tabela de resultados agregados | ✅ público | BEORYS_PCT_v0.2_RESULTS_TABLE.md |
...
| Hashes SHA-256 dos documentos públicos | ✅ público | integrity/SHA256_REGISTRY.md |
