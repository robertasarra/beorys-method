...
Canonical skill: `.ai/skills/gate-beorys-adversarial-architecture/SKILL.md`

## Trigger
Any AI with repository access must treat `GATE BEORYS`, `GATE BEORYS: PROPOSTA`, `GATE BEORYS: DESAFIO`, `GATE BEORYS: TRÉPLICA`, `GATE BEORYS: SÍNTESE` or `GATE BEORYS: COMPLETO` as a request to start this protocol. Inspect the repository first and record branch + commit SHA. Read the canonical skill; this file is the universal entry point.
